...
int main( void ) {
    ...
    for( i = 0; com[ i ] != "\0"; ++i ) {
		...
		if( V[ 0 ] == "NOP" )
			outputFile << "0000000000000000" << endl;
		if( V[ 0 ] == "STORE" ) {
			sol = "00010";
			int a = num( V[ 1 ] ); // second number
			string B = binary( a ), z = "";
		...
		if( V[ 0 ] == "JMP" ) {
			...
			for( int k = 0; k < 11-B.length(); ++k )
				z = z+"0";
			outputFile << "00101"+z+B << endl;
		}
		if( V[ 0 ] == "JMPI" ) {
			string B = binary( num( V[ 1 ] ) ), z = "";
			for( int k = 0; k < 11-B.length(); ++k )
				z = z+"0";
			outputFile << "00110"+z+B << endl;
		}
		if( V[ 0 ] == "INC" ) {
			string B = V[ 1 ], z = "", B2 = "";
		...
		if( V[ 0 ] == "END" ) {
			outputFile << "1011000000000000" << endl;
		}
